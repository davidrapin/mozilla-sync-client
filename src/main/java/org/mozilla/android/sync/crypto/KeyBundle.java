...
public class KeyBundle
{
     ...
     *
     * @param account An account string.
     * @return An acceptable string.
     * @throws UnsupportedEncodingException if UTF-8 is not found on the system
     * @throws NoSuchAlgorithmException if SHA-Base32 is not found on the system
     */
    public static String usernameFromAccount(String account)
     ...
     * @param base32SyncKey The Sync Key
     *
     * @throws java.security.InvalidKeyException if the key is an invalid HMAC-SHA256 key.
     * @throws CryptoException if HMAC-SHA256 was not found on the system
     */
    ...
    public static KeyBundle decodeKeyStrings(String base64EncryptionKey, String base64HmacKey)
        throws UnsupportedEncodingException
    {
        return new KeyBundle(
            Base64.decodeBase64(base64EncryptionKey.getBytes("UTF-8")),
